...
parser.add_argument('--data', type=str, default='./data/yelp', help='location of the data corpus')
...
parser.add_argument('--save', type=str,  default='Attentive-yelp.pt', help='path to save the final model')
...
emb_matrix = torch.load( 'data/yelp/emb_matrix.pt' )
word_idx_list = torch.load( 'data/yelp/word_idx_list.pt' )
if args.cuda:
    emb_matrix.cuda()
    word_idx_list.cuda()
